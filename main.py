...
#		print(initial_phi)
        ...
        [self.theta, self.phi] = np.mgrid[initial_theta:end_theta+1:step_theta,initial_phi:end_phi+1:step_phi]
#		print(self.phi)
...
if __name__ == '__main__':
    temp = Data_table('new_data.csv')
#   print(temp)

    temp.draw()
    print(temp.interpolate(theta=120,phi=60))
